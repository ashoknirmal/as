...
import {  Python, MongoDB, FireBase, ReactJS, NodeJs, JavaScript } from "../asset/svg/svg";
import { useSelector } from "react-redux";
const skills = [ Python, FireBase, ReactJS, JavaScript, NodeJs, MongoDB];
const skillNames=["Python","Firebase","ReactJs","JavaScript","NodeJs","MongoDB"];
